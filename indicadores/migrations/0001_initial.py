# Generated by Django 4.2.1 on 2023-07-25 22:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateField(default=datetime.date(2023, 7, 25))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Id_NivelAdministrativo', models.AutoField(auto_created=True, primary_key=True, serialize=False)),
                ('niveladministrativonombre', models.CharField(max_length=230)),
            ],
        ),
        migrations.CreateModel(
            name='Objetivo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluacion', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='respuestas_objetivo', to='indicadores.evaluacion')),
                ('objetivo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='respuestas', to='indicadores.objetivo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lideres', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='empleado',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='empleados', to=settings.AUTH_USER_MODEL),
        ),
    ]
